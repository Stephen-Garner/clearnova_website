        ...
        {(eyebrow || title || description) && (
          ...
          >
            {eyebrow && (
              <div
                className={cn(
                  "inline-flex items-center gap-2 mb-5 rounded-full border border-border-strong bg-white/[0.04] px-3 py-1 text-[11px] font-semibold tracking-[0.18em] text-brand-300 uppercase"
                )}
              >
